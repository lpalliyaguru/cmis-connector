...
/**
 * ChangelogMessageProcessor invokes the {@link org.mule.module.cmis.CMISCloudConnector#changelog(java.lang.String, boolean)} method in {@link CMISCloudConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISCloudConnector at changelog retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
