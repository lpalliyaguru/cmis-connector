        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((CMISCloudConnector) object).applyPolicy(_transformedCmisObject, _transformedObjectId, _transformedPolicyIds);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISCloudConnector at applyPolicy retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
