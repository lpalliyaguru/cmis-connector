...
import org.mule.module.cmis.processors.CreateDocumentByIdFromContentMessageProcessor;
...
public class CreateDocumentByIdFromContentDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{

    private static Logger logger = LoggerFactory.getLogger(CreateDocumentByIdFromContentDefinitionParser.class);

    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition(CreateDocumentByIdFromContentMessageProcessor.class.getName());
            ...
            logger.error(("Cannot launch the mule app, the @Processor [create-document-by-id-from-content] within the connector [cmis] is not supported in mule "+ muleVersion));
            throw new BeanDefinitionParsingException(new Problem(("Cannot launch the mule app, the @Processor [create-document-by-id-from-content] within the connector [cmis] is not supported in mule "+ muleVersion), new Location(parserContext.getReaderContext().getResource()), null, noClassDefFoundError));
        }
    }

    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = getBeanDefinitionBuilder(parserContext);
        builder.addConstructorArgValue("createDocumentByIdFromContent");
