    ...
    extends AbstractDevkitBasedDefinitionParser
{
    ...
    private static Logger logger = LoggerFactory.getLogger(CMISCloudConnectorConfigDefinitionParser.class);
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition(CMISCloudConnectorConnectionManager.class.getName());
