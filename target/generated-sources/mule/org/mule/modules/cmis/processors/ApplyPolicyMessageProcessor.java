...
/**
 * ApplyPolicyMessageProcessor invokes the {@link org.mule.modules.cmis.CMISConnector#applyPolicy(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String, java.util.List)} method in {@link CMISConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected Object policyIds;
    protected List<ObjectId> _policyIdsType;

    public ApplyPolicyMessageProcessor(String operationName) {
        super(operationName);
    }
     ...
     */
    public void setPolicyIds(Object value) {
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((CMISConnector) object).applyPolicy(_transformedCmisObject, _transformedObjectId, _transformedPolicyIds);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISConnector at applyPolicy retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
