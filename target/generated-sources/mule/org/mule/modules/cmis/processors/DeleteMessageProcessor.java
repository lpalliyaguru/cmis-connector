...
/**
 * DeleteMessageProcessor invokes the {@link org.mule.modules.cmis.CMISConnector#delete(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String, boolean)} method in {@link CMISConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((CMISConnector) object).delete(_transformedCmisObject, _transformedObjectId, _transformedAllVersions);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISConnector at delete retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
