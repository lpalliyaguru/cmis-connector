...
/**
 * CancelCheckOutMessageProcessor invokes the {@link org.mule.modules.cmis.CMISConnector#cancelCheckOut(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String)} method in {@link CMISConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public CancelCheckOutMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((CMISConnector) object).cancelCheckOut(_transformedDocument, _transformedDocumentId);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISConnector at cancelCheckOut retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
