...
/**
 * GetParentFoldersMessageProcessor invokes the {@link org.mule.modules.cmis.CMISConnector#getParentFolders(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String)} method in {@link CMISConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISConnector at getParentFolders retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
