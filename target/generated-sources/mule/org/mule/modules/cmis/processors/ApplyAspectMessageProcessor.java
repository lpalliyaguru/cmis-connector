...
/**
 * ApplyAspectMessageProcessor invokes the {@link org.mule.modules.cmis.CMISConnector#applyAspect(java.lang.String, java.lang.String, java.util.Map)} method in {@link CMISConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final Map<String, Object> _transformedProperties = ((Map<String, Object> ) evaluateAndTransform(getMuleContext(), event, ApplyAspectMessageProcessor.class.getDeclaredField("_propertiesType").getGenericType(), null, properties));
    ...
    public Result<MetaData> getInputMetaData() {
        return new DefaultResult<MetaData>(new DefaultMetaData(new DefaultParameterizedMapMetaDataModel(getPojoOrSimpleModel(String.class), getPojoOrSimpleModel(Object.class))));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISConnector at applyAspect retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
