...
/**
 * QueryMessageProcessor invokes the {@link org.mule.modules.cmis.CMISConnector#query(java.lang.String, boolean, java.lang.String, java.lang.String, org.mule.streaming.PagingConfiguration)} method in {@link CMISConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ProviderAwarePagingDelegate paginationProvider = ((CMISConnector) object).query(_transformedStatement, _transformedSearchAllVersions, _transformedFilter, _transformedOrderBy, pagingConfiguration);
                    return new ManagedPagingDelegateAdapter(paginationProvider, processTemplate, getManagedExceptions(), isProtected(), messageProcessor, event);
                }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(new DefaultListMetaDataModel(getPojoOrSimpleModel(QueryResult.class))));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISConnector at query retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
