...
/**
 * CreateRelationshipMessageProcessor invokes the {@link org.mule.modules.cmis.CMISConnector#createRelationship(java.lang.String, java.lang.String, java.lang.String)} method in {@link CMISConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public CreateRelationshipMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((CMISConnector) object).createRelationship(_transformedParentObjectId, _transformedChildObjectId, _transformedRelationshipType);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISConnector at createRelationship retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
