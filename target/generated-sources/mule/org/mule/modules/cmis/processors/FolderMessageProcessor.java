...
/**
 * FolderMessageProcessor invokes the {@link org.mule.modules.cmis.CMISConnector#folder(org.apache.chemistry.opencmis.client.api.Folder, java.lang.String, org.mule.modules.cmis.model.NavigationOptions, java.lang.Integer, java.lang.String, java.lang.String)} method in {@link CMISConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((CMISConnector) object).folder(_transformedFolder, _transformedFolderId, _transformedGet, _transformedDepth, _transformedFilter, _transformedOrderBy);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISConnector at folder retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
