...
/**
 * ApplyAclMessageProcessor invokes the {@link org.mule.modules.cmis.CMISConnector#applyAcl(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String, java.util.List, java.util.List, org.apache.chemistry.opencmis.commons.enums.AclPropagation)} method in {@link CMISConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((CMISConnector) object).applyAcl(_transformedCmisObject, _transformedObjectId, _transformedAddAces, _transformedRemoveAces, _transformedAclPropagation);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CMISConnector at applyAcl retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
