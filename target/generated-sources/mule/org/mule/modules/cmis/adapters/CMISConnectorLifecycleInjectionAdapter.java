...
/**
 * A <code>CMISConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link CMISConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.1", date = "2015-10-14T01:33:34-03:00", comments = "Build UNNAMED.2613.77421cc")
public class CMISConnectorLifecycleInjectionAdapter
    extends CMISConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(CMISConnectorLifecycleInjectionAdapter.class);
