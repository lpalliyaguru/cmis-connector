...
public class CMISCloudConnector implements CMISFacade
{
     ...
     */
    @Processor
    public ChangeEvents changelog(@Optional final String changeLogToken,
    ...
    public ObjectId createDocumentByPath(final String folderPath,
                                         ...
                                         @Optional final Map<String, String> properties,
                                         @Optional @Default("false") final boolean force)
    {
    ...
    public ObjectId createDocumentById(final String folderId,
                                       ...
                                       final VersioningState versioningState,
                                       final String objectType,
                                       @Optional @Default("false") final Map<String, String> properties)
    {
     ...
     */
    @Processor
    public ObjectId checkOut(@Optional final CmisObject document,
                             @Optional final String documentId)
    {
     ...
     */
    @Processor
    public ObjectId checkIn(@Optional final CmisObject document,
                            @Optional final String documentId,
                            @Payload Object content,
                            final String filename,
                            final String mimeType,
