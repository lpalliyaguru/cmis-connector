...
public interface CMISFacade {
     ...
     *            An enumeration specifying what the versioing state of the newly-created object MUST be. If the repository does not support versioning, the repository MUST ignore
     *            the versioningState parameter. Valid values are: o none: The document MUST be created as a non-versionable document. o checkedout: The document MUST be created in
     *            the checked-out state. o major (default): The document MUST be created as a major version o minor: The document MUST be created as a minor version.
     * @param objectType
     ...
     */
    ObjectId createDocumentByPath(String folderPath, String filename, Object content, String mimeType, VersioningState versioningState, String objectType,
     ...
     * @return the object id {@link ObjectId} of the created
     */
    ObjectId createDocumentById(String folderId, String filename, Object content, String mimeType, VersioningState versioningState, String objectType,
     ...
     */
    ProviderAwarePagingDelegate<QueryResult, CMISConnector> query(String statement, boolean searchAllVersions, String filter, String orderBy,
     ...
     *         <li>DESCENDANTS: List<Tree<FileableCmisObject>> representing the whole descentants tree of the current folder</li>
     *         <li>TREE: List<Tree<FileableCmisObject>> representing the directory structure under the current folder.</li>
     *         </ul>
     */
     ...
     */
    CmisObject updateObjectProperties(CmisObject cmisObject, String objectId, Map<String, Object> properties);
     ...
     */
    ObjectId checkIn(CmisObject document, String documentId, Object content, String filename, String mimeType, boolean major, String checkinComment, Map<String, Object> properties);
     ...
     * @param properties
     *            The properties to set. Can be null.
     * @return The updated object (a repository might have created a new object)
     */
    void applyAspect(String objectId, String aspectName, Map<String, Object> properties);
