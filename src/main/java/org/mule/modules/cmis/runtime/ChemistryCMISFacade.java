...
public class ChemistryCMISFacade implements CMISFacade {
    ...
    public ObjectId createDocumentById(@NotNull(value = "No folderId was specified in the request.") String folderId,
            ...
            @NotNull(value = "No file mime type was specified in the request.") String mimeType, org.mule.modules.cmis.model.VersioningState versioningState,
    ...
    protected ObjectId createDocument(@NotNull(value = "No folder was specified in the request.") CmisObject folder,
            ...
            @NotNull(value = "No versioning state was specified in the request.") org.mule.modules.cmis.model.VersioningState versioningState, String objectType,
